...
$manifest = array (
  ...
  'name' => 'Selkirk',
  'published_date' => '2014-09-02 18:09:22',
  'type' => 'module',
  'version' => 1409681362,
...
$installdefs = array (
  ...
  array (
    ...
    array (
      ...
      'class' => 'sel_Selkirk_Student_Project',
      'path' => 'modules/sel_Selkirk_Student_Project/sel_Selkirk_Student_Project.php',
      'tab' => true,
    ),
    1 => 
    array (
    ...
    array (
      ...
      'class' => 'sel_Selkirk_Student_Project_Activity',
      'path' => 'modules/sel_Selkirk_Student_Project_Activity/sel_Selkirk_Student_Project_Activity.php',
      'tab' => true,
    ),
    11 => 
    array (
  ...
  array (
    0 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/sel_selkirk_student_project_sel_selkirk_student_project_activity_sel_Selkirk_Student_Project_Activity.php',
      'to_module' => 'sel_Selkirk_Student_Project_Activity',
    ),
    1 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/sel_selkirk_student_project_sel_selkirk_student_project_activity_sel_Selkirk_Student_Project.php',
      'to_module' => 'sel_Selkirk_Student_Project',
    ),
    2 => 
    array (
    ...
    9 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/sel_selkirk_document_securitygroups_sel_Selkirk_Template.php',
    ...
    42 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/sel_selkirk_student_project_activity_sel_selkirk_client_sel_Selkirk_Client.php',
      'to_module' => 'sel_Selkirk_Client',
    ),
    43 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/sel_selkirk_student_project_activity_sel_selkirk_client_sel_Selkirk_Student_Project_Activity.php',
      'to_module' => 'sel_Selkirk_Student_Project_Activity',
    ),
    44 => 
    array (
  ...
  array (
    0 => 
    array (
      'meta_data' => '<basepath>/SugarModules/relationships/relationships/sel_selkirk_student_project_sel_selkirk_student_project_activityMetaData.php',
    ),
    1 => 
    array (
    ...
    25 => 
    array (
      'meta_data' => '<basepath>/SugarModules/relationships/relationships/sel_selkirk_student_project_activity_sel_selkirk_clientMetaData.php',
    ),
    26 => 
    array (
  ...
  array (
    0 => 
    array (
      'from' => '<basepath>/SugarModules/modules/sel_Selkirk_Student_Project',
      'to' => 'modules/sel_Selkirk_Student_Project',
    ),
    1 => 
    array (
    ...
    10 => 
    array (
      'from' => '<basepath>/SugarModules/modules/sel_Selkirk_Student_Project_Activity',
      'to' => 'modules/sel_Selkirk_Student_Project_Activity',
    ),
    11 => 
    array (
  ...
  array (
    0 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/language/sel_Selkirk_Student_Project_Activity.php',
      'to_module' => 'sel_Selkirk_Student_Project_Activity',
      'language' => 'en_us',
    ),
    1 => 
    ...
    3 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/language/sel_Selkirk_Student_Project.php',
      'to_module' => 'sel_Selkirk_Student_Project',
      'language' => 'en_us',
    ),
    4 => 
  ...
  array (
    0 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/sel_selkirk_student_project_sel_selkirk_student_project_activity_sel_Selkirk_Student_Project_Activity.php',
      'to_module' => 'sel_Selkirk_Student_Project_Activity',
    ),
    1 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/sel_selkirk_student_project_sel_selkirk_student_project_activity_sel_Selkirk_Student_Project.php',
      'to_module' => 'sel_Selkirk_Student_Project',
    ),
    2 => 
    array (
    ...
    9 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/sel_selkirk_document_securitygroups_sel_Selkirk_Template.php',
      'to_module' => 'sel_Selkirk_Template',
    ),
    10 => 
    array (
    ...
    50 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/sel_selkirk_student_project_activity_sel_selkirk_client_sel_Selkirk_Client.php',
      'to_module' => 'sel_Selkirk_Client',
    ),
    51 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/sel_selkirk_student_project_activity_sel_selkirk_client_sel_Selkirk_Student_Project_Activity.php',
      'to_module' => 'sel_Selkirk_Student_Project_Activity',
    ),
    52 => 
    array (
