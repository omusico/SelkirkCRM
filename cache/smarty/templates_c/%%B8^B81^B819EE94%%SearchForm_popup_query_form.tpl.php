<?php /* Smarty version 2.6.11, created on 2014-10-15 16:30:40
         compiled from cache/modules/sel_Selkirk_Project/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/sel_Selkirk_Project/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/modules/sel_Selkirk_Project/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/sel_Selkirk_Project/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/sel_Selkirk_Project/SearchForm_popup_query_form.tpl', 44, false),array('function', 'sugar_getimage', 'cache/modules/sel_Selkirk_Project/SearchForm_popup_query_form.tpl', 87, false),array('function', 'html_options', 'cache/modules/sel_Selkirk_Project/SearchForm_popup_query_form.tpl', 150, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'sel_Selkirk_Project'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='project_lead_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_LEAD','module' => 'sel_Selkirk_Project'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['project_lead_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['project_lead_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['project_lead_advanced']['value']; ?>
...
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['project_lead_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['project_lead_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"user_id_c_advanced","name":"project_lead_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['project_lead_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['project_lead_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='department_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEPARTMENT','module' => 'sel_Selkirk_Project'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['department_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['department_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['department_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_id_c_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_id_c_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['department_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['department_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"sel_selkirk_client_id_c_advanced","name":"department_advanced"}}'; ?>
, "single", true);'><?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_SELECT'],'name' => "id-ff-select",'ext' => ".png",'other_attributes' => ''), $this);?>
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['department_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['department_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_id_c_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
</button>
</span>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='project_type_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROJECT_TYPE','module' => 'sel_Selkirk_Project'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'project_type_advanced','name' => 'project_type_advanced[]','options' => $this->_tpl_vars['fields']['project_type_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['project_type_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'sel_Selkirk_Project'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
