<?php /* Smarty version 2.6.11, created on 2014-07-07 14:17:40
         compiled from cache/modules/sel_Selkirk_Contact/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/sel_Selkirk_Contact/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/modules/sel_Selkirk_Contact/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/sel_Selkirk_Contact/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/sel_Selkirk_Contact/SearchForm_popup_query_form.tpl', 44, false),array('function', 'html_options', 'cache/modules/sel_Selkirk_Contact/SearchForm_popup_query_form.tpl', 156, false),array('function', 'sugar_getimage', 'cache/modules/sel_Selkirk_Contact/SearchForm_popup_query_form.tpl', 187, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'sel_Selkirk_Contact'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='address_line_1_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_LINE_1','module' => 'sel_Selkirk_Contact'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['address_line_1_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['address_line_1_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['address_line_1_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['address_line_1_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['address_line_1_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='email_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL','module' => 'sel_Selkirk_Contact'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='business_cycle_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BUSINESS_CYCLE','module' => 'sel_Selkirk_Contact'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'business_cycle_advanced','name' => 'business_cycle_advanced[]','options' => $this->_tpl_vars['fields']['business_cycle_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['business_cycle_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='assigned_user_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'sel_Selkirk_Contact'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
