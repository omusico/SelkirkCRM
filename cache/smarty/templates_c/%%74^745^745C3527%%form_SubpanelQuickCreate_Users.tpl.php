<?php /* Smarty version 2.6.11, created on 2014-11-19 16:30:00
         compiled from cache/modules/Users/form_SubpanelQuickCreate_Users.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 4, false),array('function', 'sugar_action_menu', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 93, false),array('function', 'sugar_include', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 114, false),array('function', 'counter', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 120, false),array('function', 'sugar_translate', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 126, false),array('function', 'html_options', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 186, false),array('function', 'sugar_getimagepath', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 214, false),array('function', 'sugar_help', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 610, false),array('function', 'sugar_image', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 933, false),array('modifier', 'default', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 119, false),array('modifier', 'strip_semicolon', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 127, false),array('modifier', 'lookup', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 211, false),array('modifier', 'count', 'cache/modules/Users/form_SubpanelQuickCreate_Users.tpl', 291, false),)), $this); ?>
...
<div id="form_SubpanelQuickCreate_Users_tabs"
>
<div >
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_Users","field_to_name_array":{"id":"reports_to_id","last_name":"reports_to_name"}}'; ?>
, 
"single", 
true
...
YAHOO.util.Event.onContentReady("form_SubpanelQuickCreate_Users",
    function () { initEditView(document.forms.form_SubpanelQuickCreate_Users) });
...
<script type="text/javascript">
addForm(\'form_SubpanelQuickCreate_Users\');addToValidate(\'form_SubpanelQuickCreate_Users\', \'user_name\', \'user_name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_USER_NAME','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'user_hash\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_USER_HASH','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'system_generated_password\', \'bool\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SYSTEM_GENERATED_PASSWORD','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'pwd_last_changed_date\', \'date\', false,\'Password Last Changed\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'authenticate_id\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AUTHENTICATE_ID','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'sugar_login\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUGAR_LOGIN','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'first_name\', \'name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'last_name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_NAME','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'full_name\', \'name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'name\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'is_admin\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_IS_ADMIN','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'external_auth_only\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EXT_AUTHENTICATE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'receive_notifications\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RECEIVE_NOTIFICATIONS','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'date_entered_date\', \'date\', true,\'Date Entered\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'date_modified_date\', \'date\', true,\'Date Modified\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_BY_ID','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'modified_by_name\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_BY','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'created_by_name\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED_BY_NAME','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'title\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TITLE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'department\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DEPARTMENT','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'phone_home\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_HOME_PHONE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'phone_mobile\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MOBILE_PHONE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'phone_work\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_WORK_PHONE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'phone_other\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OTHER_PHONE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'phone_fax\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FAX_PHONE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'status\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'address_street\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_STREET','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'address_city\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_CITY','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'address_state\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_STATE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'address_country\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_COUNTRY','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'address_postalcode\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_POSTALCODE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'UserType\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_USER_TYPE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'portal_only\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PORTAL_ONLY_USER','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'show_on_employees\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SHOW_ON_EMPLOYEES','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'employee_status\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMPLOYEE_STATUS','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'messenger_id\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MESSENGER_ID','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'messenger_type\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MESSENGER_TYPE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'reports_to_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REPORTS_TO_ID','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'reports_to_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REPORTS_TO_NAME','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'email1\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'email_link_type\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_LINK_TYPE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'is_group\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_GROUP_USER','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'c_accept_status_fields\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_ACCEPT_STATUS','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'m_accept_status_fields\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_ACCEPT_STATUS','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'accept_status_id\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_ACCEPT_STATUS','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'accept_status_name\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_ACCEPT_STATUS','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'dash_dashboardmanager_users_2_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DASH_DASHBOARDMANAGER_USERS_2_FROM_DASH_DASHBOARDMANAGER_TITLE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'dash_dashboardmanager_users_1_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DASH_DASHBOARDMANAGER_USERS_1_FROM_DASH_DASHBOARDMANAGER_TITLE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'dash_dashboardmanager_users_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DASH_DASHBOARDMANAGER_USERS_FROM_DASH_DASHBOARDMANAGER_TITLE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'securitygroup_noninher_fields\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_USER_NAME','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'securitygroup_noninherit_id\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_securitygroup_noninherit_id','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'securitygroup_noninheritable\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SECURITYGROUP_NONINHERITABLE','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Users\', \'securitygroup_primary_group\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_GROUP','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidateBinaryDependency(\'form_SubpanelQuickCreate_Users\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Users','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Users','for_js' => true), $this); echo '\', \'assigned_user_id\' );
addToValidateBinaryDependency(\'form_SubpanelQuickCreate_Users\', \'reports_to_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Users','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_REPORTS_TO_NAME','module' => 'Users','for_js' => true), $this); echo '\', \'reports_to_id\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'form_SubpanelQuickCreate_Users_reports_to_name\']={"form":"form_SubpanelQuickCreate_Users","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name","reports_to_id"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>
