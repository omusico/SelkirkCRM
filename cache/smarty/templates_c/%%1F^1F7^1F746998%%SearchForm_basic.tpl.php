<?php /* Smarty version 2.6.11, created on 2015-03-26 18:14:56
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'sel_Selkirk_Approvals'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='assigned_user_name_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'sel_Selkirk_Approvals'), $this);?>
</label>
    	</td>
...
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['assigned_user_id_basic']['name']; ?>
...
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"assigned_user_id_basic","name":"assigned_user_name_basic"}}'; ?>
