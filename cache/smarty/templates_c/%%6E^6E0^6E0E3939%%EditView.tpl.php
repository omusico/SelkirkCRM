<?php /* Smarty version 2.6.11, created on 2015-02-10 13:23:35
...
, "single", true);'><img src="themes/default/images/id-ff-select.png?v=MbXVTRbw0Y06WfxbvAqZog"     alt="Select" /></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['reports_to_name']['name']; ?>
...
"><img src="themes/default/images/id-ff-clear.png?v=MbXVTRbw0Y06WfxbvAqZog"     alt="Clear" /></button></span><?php else:  echo $this->_tpl_vars['fields']['reports_to_name']['value']; ?>
<input accesskey=""  tabindex="0"  type="hidden" name="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['reports_to_id']['value']; ?>
"><?php endif; ?>
...
addToValidate(\'EditView\', \'dash_dashboardmanager_users_2_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DASH_DASHBOARDMANAGER_USERS_2_FROM_DASH_DASHBOARDMANAGER_TITLE','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'dash_dashboardmanager_users_1_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DASH_DASHBOARDMANAGER_USERS_1_FROM_DASH_DASHBOARDMANAGER_TITLE','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'dash_dashboardmanager_users_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DASH_DASHBOARDMANAGER_USERS_FROM_DASH_DASHBOARDMANAGER_TITLE','module' => 'Employees','for_js' => true), $this); echo '\' );
