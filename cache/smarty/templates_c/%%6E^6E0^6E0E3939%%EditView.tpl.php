<?php /* Smarty version 2.6.11, created on 2014-07-15 17:01:41
...
, "single", true);'><img src="themes/default/images/id-ff-select.png?v=aQsfRAHJjqLPKnrvvrOEeQ"     alt="Select" /></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['reports_to_name']['name']; ?>
...
"><img src="themes/default/images/id-ff-clear.png?v=aQsfRAHJjqLPKnrvvrOEeQ"     alt="Clear" /></button></span><?php else:  echo $this->_tpl_vars['fields']['reports_to_name']['value']; ?>
<input accesskey=""  tabindex="0"  type="hidden" name="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['reports_to_id']['value']; ?>
"><?php endif; ?>
