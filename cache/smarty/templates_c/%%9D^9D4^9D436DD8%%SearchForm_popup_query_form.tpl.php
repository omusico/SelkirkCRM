<?php /* Smarty version 2.6.11, created on 2014-10-15 12:16:08
         compiled from cache/modules/sel_Selkirk_Document/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/sel_Selkirk_Document/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/modules/sel_Selkirk_Document/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/sel_Selkirk_Document/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/sel_Selkirk_Document/SearchForm_popup_query_form.tpl', 44, false),array('function', 'sugar_getimage', 'cache/modules/sel_Selkirk_Document/SearchForm_popup_query_form.tpl', 69, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='document_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'sel_Selkirk_Document'), $this);?>
</label>
		</td>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'popup_query_form_modified_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_created_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_assigned_user_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_sel_selkirk_template_sel_selkirk_document_name_advanced\']={"form":"popup_query_form","method":"query","modules":["sel_Selkirk_Template"],"group":"or","field_list":["name","id"],"populate_list":["sel_selkirk_template_sel_selkirk_document_name_advanced","sel_selkir95fdemplate_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_sel_selkirk_business_case_sel_selkirk_document_name_advanced\']={"form":"popup_query_form","method":"query","modules":["sel_Selkirk_Business_Case"],"group":"or","field_list":["name","id"],"populate_list":["sel_selkirk_business_case_sel_selkirk_document_name_advanced","sel_selkirae30ss_case_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>