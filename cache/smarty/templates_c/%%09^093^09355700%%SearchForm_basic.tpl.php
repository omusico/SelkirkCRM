<?php /* Smarty version 2.6.11, created on 2014-07-07 13:41:12
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'sel_Selkirk_Contact'), $this);?>
...
<?php echo smarty_function_html_options(array('id' => 'business_cycle_basic','name' => 'business_cycle_basic[]','options' => $this->_tpl_vars['fields']['business_cycle_basic']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['business_cycle_basic']['value']), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='email_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL','module' => 'sel_Selkirk_Contact'), $this);?>
</label>
    	</td>
...
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='address_line_1_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS_LINE_1','module' => 'sel_Selkirk_Contact'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['address_line_1_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['address_line_1_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['address_line_1_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['address_line_1_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['address_line_1_basic']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='assigned_user_name_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'sel_Selkirk_Contact'), $this);?>
</label>
    	</td>
