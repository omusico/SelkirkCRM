<?php /* Smarty version 2.6.11, created on 2015-03-06 10:38:21
         compiled from cache/modules/sel_Selkirk_Activity/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/sel_Selkirk_Activity/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/sel_Selkirk_Activity/EditView.tpl', 50, false),array('function', 'sugar_translate', 'cache/modules/sel_Selkirk_Activity/EditView.tpl', 56, false),array('function', 'html_options', 'cache/modules/sel_Selkirk_Activity/EditView.tpl', 70, false),array('function', 'sugar_getimagepath', 'cache/modules/sel_Selkirk_Activity/EditView.tpl', 98, false),array('function', 'sugar_getimage', 'cache/modules/sel_Selkirk_Activity/EditView.tpl', 356, false),array('modifier', 'strip_semicolon', 'cache/modules/sel_Selkirk_Activity/EditView.tpl', 57, false),array('modifier', 'lookup', 'cache/modules/sel_Selkirk_Activity/EditView.tpl', 95, false),array('modifier', 'count', 'cache/modules/sel_Selkirk_Activity/EditView.tpl', 175, false),array('modifier', 'default', 'cache/modules/sel_Selkirk_Activity/EditView.tpl', 367, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=sel_Selkirk_Activity'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"user_id_c","name":"contacted_by"}}'; ?>
, 
"single", 
true
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"sel_selkirk_contact_sel_selkirk_activitysel_selkirk_contact_ida","name":"sel_selkirk_contact_sel_selkirk_activity_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"sel_selkirk_client_sel_selkirk_activitysel_selkirk_client_ida","name":"sel_selkirk_client_sel_selkirk_activity_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'contact_date\', \'date\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_DATE','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'user_id_c\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTED_BY_USER_ID','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'contacted_by\', \'relate\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTED_BY','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'method_of_contact\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_METHOD_OF_CONTACT','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'sel_selkirk_client_sel_selkirk_activity_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SEL_SELKIRK_CLIENT_SEL_SELKIRK_ACTIVITY_FROM_SEL_SELKIRK_CLIENT_TITLE','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'sel_selkirk_contact_sel_selkirk_activity_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SEL_SELKIRK_CONTACT_SEL_SELKIRK_ACTIVITY_FROM_SEL_SELKIRK_CONTACT_TITLE','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\' );
...
addToValidateBinaryDependency(\'EditView\', \'contacted_by\', \'alpha\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTED_BY','module' => 'sel_Selkirk_Activity','for_js' => true), $this); echo '\', \'user_id_c\' );
