<?php /* Smarty version 2.6.11, created on 2014-11-21 10:10:53
         compiled from cache/modules/sel_Selkirk_Template/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/sel_Selkirk_Template/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/sel_Selkirk_Template/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/modules/sel_Selkirk_Template/DetailView.tpl', 47, false),array('modifier', 'strip_semicolon', 'cache/modules/sel_Selkirk_Template/DetailView.tpl', 48, false),array('modifier', 'escape', 'cache/modules/sel_Selkirk_Template/DetailView.tpl', 178, false),array('modifier', 'url2html', 'cache/modules/sel_Selkirk_Template/DetailView.tpl', 178, false),array('modifier', 'nl2br', 'cache/modules/sel_Selkirk_Template/DetailView.tpl', 178, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='sel_Selkirk_Template'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='sel_Selkirk_Template'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='sel_Selkirk_Template'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
<div id="sel_Selkirk_Template_detailview_tabs"
>
<div >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['sel_selkirk_business_case_sel_selkirk_document_name']['hidden']): ?>
&nbsp;
<?php endif; ?>
</td>
<td width='37.5%' colspan='3' >
<?php if (! $this->_tpl_vars['fields']['sel_selkirk_business_case_sel_selkirk_document_name']['hidden']):  endif; ?>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
