<?php /* Smarty version 2.6.11, created on 2014-12-17 12:36:02
         compiled from cache/modules/sel_Selkirk_Service/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/sel_Selkirk_Service/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/sel_Selkirk_Service/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/sel_Selkirk_Service/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/sel_Selkirk_Service/SearchForm_advanced.tpl', 44, false),array('function', 'sugar_getimage', 'cache/modules/sel_Selkirk_Service/SearchForm_advanced.tpl', 87, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'sel_Selkirk_Service'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='sel_selkirk_project_sel_selkirk_service_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SEL_SELKIRK_PROJECT_SEL_SELKIRK_SERVICE_FROM_SEL_SELKIRK_PROJECT_TITLE','module' => 'sel_Selkirk_Service'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['sel_selkirk_project_sel_selkirk_service_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['sel_selkirk_project_sel_selkirk_service_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['sel_selkirk_project_sel_selkirk_service_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['sel_selkirk_project_sel_selkirk_servicesel_selkirk_project_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['sel_selkirk_project_sel_selkirk_servicesel_selkirk_project_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['sel_selkirk_project_sel_selkirk_service_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['sel_selkirk_project_sel_selkirk_service_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"sel_selkirk_project_sel_selkirk_servicesel_selkirk_project_ida_advanced","name":"sel_selkirk_project_sel_selkirk_service_name_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['sel_selkirk_project_sel_selkirk_service_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['sel_selkirk_project_sel_selkirk_service_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['sel_selkirk_project_sel_selkirk_servicesel_selkirk_project_ida_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='sel_selkirk_client_sel_selkirk_service_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SEL_SELKIRK_CLIENT_SEL_SELKIRK_SERVICE_FROM_SEL_SELKIRK_CLIENT_TITLE','module' => 'sel_Selkirk_Service'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_sel_selkirk_service_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_sel_selkirk_service_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_sel_selkirk_service_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_sel_selkirk_servicesel_selkirk_client_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_sel_selkirk_servicesel_selkirk_client_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_sel_selkirk_service_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_sel_selkirk_service_name_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"sel_selkirk_client_sel_selkirk_servicesel_selkirk_client_ida_advanced","name":"sel_selkirk_client_sel_selkirk_service_name_advanced"}}'; ?>
, "single", true);'><?php echo smarty_function_sugar_getimage(array('alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_SELECT'],'name' => "id-ff-select",'ext' => ".png",'other_attributes' => ''), $this);?>
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_sel_selkirk_service_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_sel_selkirk_service_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['sel_selkirk_client_sel_selkirk_servicesel_selkirk_client_ida_advanced']['name']; ?>
.value = '';" value="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
</button>
</span>
