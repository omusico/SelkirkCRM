<?php /* Smarty version 2.6.11, created on 2014-06-25 11:50:28
         compiled from cache/modules/sel_Selkirk_Activity/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/sel_Selkirk_Activity/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/modules/sel_Selkirk_Activity/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/sel_Selkirk_Activity/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/sel_Selkirk_Activity/SearchForm_popup_query_form.tpl', 45, false),array('function', 'sugar_getimage', 'cache/modules/sel_Selkirk_Activity/SearchForm_popup_query_form.tpl', 88, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'sel_Selkirk_Activity'), $this);?>
</label>
    	</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='contacted_by_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTED_BY','module' => 'sel_Selkirk_Activity'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['contacted_by_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['contacted_by_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['contacted_by_advanced']['value']; ?>
...
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['contacted_by_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['contacted_by_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"user_id_c_advanced","name":"contacted_by_advanced"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['contacted_by_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['contacted_by_advanced']['name']; ?>
