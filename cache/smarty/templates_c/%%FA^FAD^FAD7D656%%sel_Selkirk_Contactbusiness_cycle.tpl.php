<?php /* Smarty version 2.6.11, created on 2014-06-25 08:56:49
         compiled from cache/modules/Import/sel_Selkirk_Contactbusiness_cycle.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/modules/Import/sel_Selkirk_Contactbusiness_cycle.tpl', 10, false),array('function', 'sugar_getimagepath', 'cache/modules/Import/sel_Selkirk_Contactbusiness_cycle.tpl', 43, false),array('modifier', 'lookup', 'cache/modules/Import/sel_Selkirk_Contactbusiness_cycle.tpl', 38, false),array('modifier', 'count', 'cache/modules/Import/sel_Selkirk_Contactbusiness_cycle.tpl', 143, false),)), $this); ?>
...
" 
	...
	<?php if (isset ( $this->_tpl_vars['fields']['business_cycle']['value'] ) && $this->_tpl_vars['fields']['business_cycle']['value'] != ''): ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['business_cycle']['options'],'selected' => $this->_tpl_vars['fields']['business_cycle']['value']), $this);?>

	<?php else: ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['business_cycle']['options'],'selected' => $this->_tpl_vars['fields']['business_cycle']['default']), $this);?>

	<?php endif; ?>
	</select>
<?php else: ?>
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['business_cycle']['options']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['business_cycle']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['business_cycle']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
