<?php /* Smarty version 2.6.11, created on 2015-01-14 14:01:11
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=sel_Selkirk_Document'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<script type="text/javascript" src='include/SugarFields/Fields/File/SugarFieldFile.js?v=MbXVTRbw0Y06WfxbvAqZog'></script>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['sel_selkir95fdemplate_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"sel_selkir95fdemplate_ida","document_name":"sel_selkirk_template_sel_selkirk_document_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['id_name']; ?>
');"  value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_LABEL'), $this);?>
" ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['sel_selkirk_template_sel_selkirk_document_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'document_name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'filename\', \'varchar\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FILENAME','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'file_ext\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FILE_EXTENSION','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'file_mime_type\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MIME','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'uploadfile\', \'file\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FILE_UPLOAD','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'active_date\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DOC_ACTIVE_DATE','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'exp_date\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DOC_EXP_DATE','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'category_id\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SF_CATEGORY','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'sel_selkirk_template_sel_selkirk_document_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SEL_SELKIRK_TEMPLATE_SEL_SELKIRK_DOCUMENT_FROM_SEL_SELKIRK_TEMPLATE_TITLE','module' => 'sel_Selkirk_Document','for_js' => true), $this); echo '\' );
