<?php /* Smarty version 2.6.11, created on 2015-01-09 11:39:26
         compiled from cache/modules/AOW_WorkFlow/sel_Selkirk_ServiceEditViewselkirk_service_type.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/modules/AOW_WorkFlow/sel_Selkirk_ServiceEditViewselkirk_service_type.tpl', 10, false),array('function', 'sugar_getimagepath', 'cache/modules/AOW_WorkFlow/sel_Selkirk_ServiceEditViewselkirk_service_type.tpl', 43, false),array('modifier', 'lookup', 'cache/modules/AOW_WorkFlow/sel_Selkirk_ServiceEditViewselkirk_service_type.tpl', 38, false),array('modifier', 'count', 'cache/modules/AOW_WorkFlow/sel_Selkirk_ServiceEditViewselkirk_service_type.tpl', 143, false),)), $this); ?>
...
" 
	...
	<?php if (isset ( $this->_tpl_vars['fields']['selkirk_service_type']['value'] ) && $this->_tpl_vars['fields']['selkirk_service_type']['value'] != ''): ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['selkirk_service_type']['options'],'selected' => $this->_tpl_vars['fields']['selkirk_service_type']['value']), $this);?>

	<?php else: ?>
		<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['selkirk_service_type']['options'],'selected' => $this->_tpl_vars['fields']['selkirk_service_type']['default']), $this);?>

	<?php endif; ?>
	</select>
<?php else: ?>
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['selkirk_service_type']['options']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['selkirk_service_type']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['selkirk_service_type']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
