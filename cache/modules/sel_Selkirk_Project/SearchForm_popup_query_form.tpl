...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='sel_Selkirk_Project'}</label>
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='project_lead_advanced'>{sugar_translate label='LBL_PROJECT_LEAD' module='sel_Selkirk_Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="{$fields.project_lead_advanced.name}"  class="sqsEnabled"   id="{$fields.project_lead_advanced.name}" size="" value="{$fields.project_lead_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.user_id_c_advanced.name}" value="{$fields.user_id_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.project_lead_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.project_lead_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"user_id_c_advanced","name":"project_lead_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.project_lead_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.project_lead_advanced.name}.value = ''; this.form.{$fields.user_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='department_advanced'>{sugar_translate label='LBL_DEPARTMENT' module='sel_Selkirk_Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="{$fields.department_advanced.name}"  class="sqsEnabled"   id="{$fields.department_advanced.name}" size="" value="{$fields.department_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.sel_selkirk_client_id_c_advanced.name}" value="{$fields.sel_selkirk_client_id_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.department_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.department_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"sel_selkirk_client_id_c_advanced","name":"department_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.department_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.department_advanced.name}.value = ''; this.form.{$fields.sel_selkirk_client_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='project_type_advanced'>{sugar_translate label='LBL_PROJECT_TYPE' module='sel_Selkirk_Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{html_options id='project_type_advanced' name='project_type_advanced[]' options=$fields.project_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.project_type_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='status_advanced'>{sugar_translate label='LBL_STATUS' module='sel_Selkirk_Project'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
