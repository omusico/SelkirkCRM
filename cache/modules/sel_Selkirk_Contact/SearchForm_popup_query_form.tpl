...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='sel_Selkirk_Contact'}</label>
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='address_line_1_advanced'>{sugar_translate label='LBL_ADDRESS_LINE_1' module='sel_Selkirk_Contact'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{if strlen($fields.address_line_1_advanced.value) <= 0}
{assign var="value" value=$fields.address_line_1_advanced.default_value }
{else}
{assign var="value" value=$fields.address_line_1_advanced.value }
{/if}  
<input type='text' name='{$fields.address_line_1_advanced.name}' 
    id='{$fields.address_line_1_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='email_advanced'>{sugar_translate label='LBL_EMAIL' module='sel_Selkirk_Contact'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
<input type='text' name='{$fields.email_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='business_cycle_advanced'>{sugar_translate label='LBL_BUSINESS_CYCLE' module='sel_Selkirk_Contact'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{html_options id='business_cycle_advanced' name='business_cycle_advanced[]' options=$fields.business_cycle_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.business_cycle_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='assigned_user_name_advanced'>{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='sel_Selkirk_Contact'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
