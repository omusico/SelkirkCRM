...
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'first_name', 'varchar', false,'{/literal}{sugar_translate label='LBL_FIRST_NAME' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'office_phone', 'varchar', false,'{/literal}{sugar_translate label='LBL_OFFICE_PHONE' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'cell_phone', 'varchar', false,'{/literal}{sugar_translate label='LBL_CELL_PHONE' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'fax', 'varchar', false,'{/literal}{sugar_translate label='LBL_FAX' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'address_line_1', 'varchar', false,'{/literal}{sugar_translate label='LBL_ADDRESS_LINE_1' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'address_line_2', 'varchar', false,'{/literal}{sugar_translate label='LBL_ADDRESS_LINE_2' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'city', 'varchar', false,'{/literal}{sugar_translate label='LBL_CITY' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'province', 'varchar', false,'{/literal}{sugar_translate label='LBL_PROVINCE' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'postal_code', 'varchar', false,'{/literal}{sugar_translate label='LBL_POSTAL_CODE' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'title', 'varchar', false,'{/literal}{sugar_translate label='LBL_TITLE' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'email', 'varchar', false,'{/literal}{sugar_translate label='LBL_EMAIL' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'extension', 'varchar', false,'{/literal}{sugar_translate label='LBL_EXTENSION' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidate('EditView', 'business_cycle', 'enum', false,'{/literal}{sugar_translate label='LBL_BUSINESS_CYCLE' module='sel_Selkirk_Contact' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='sel_Selkirk_Contact' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='sel_Selkirk_Contact' for_js=true}{literal}', 'assigned_user_id' );
