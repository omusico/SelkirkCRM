...
{sugar_translate label='FIELDS' module='AOR_Reports'}
<script>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_FIELD_LINES' module='AOR_Reports'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{sugar_translate label='CONDITIONS' module='AOR_Reports'}
<script>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CONDITION_LINES' module='AOR_Reports'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
