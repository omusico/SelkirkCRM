...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_sel_Selkirk_Activity","field_to_name_array":{"id":"user_id_c","name":"contacted_by"}}{/literal}, 
"single", 
true
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_sel_Selkirk_Activity","field_to_name_array":{"id":"sel_selkirk_contact_sel_selkirk_activitysel_selkirk_contact_ida","name":"sel_selkirk_contact_sel_selkirk_activity_name"}}{/literal}, 
"single", 
true
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_sel_Selkirk_Activity","field_to_name_array":{"id":"sel_selkirk_client_sel_selkirk_activitysel_selkirk_client_ida","name":"sel_selkirk_client_sel_selkirk_activity_name"}}{/literal}, 
"single", 
true
...
YAHOO.util.Event.onContentReady("form_SubpanelQuickCreate_sel_Selkirk_Activity",
    function () {ldelim} initEditView(document.forms.form_SubpanelQuickCreate_sel_Selkirk_Activity) {rdelim});
...
<script type="text/javascript">
addForm('form_SubpanelQuickCreate_sel_Selkirk_Activity');addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='sel_Selkirk_Activity' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'contact_date', 'date', true,'{/literal}{sugar_translate label='LBL_CONTACT_DATE' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'user_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_CONTACTED_BY_USER_ID' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'contacted_by', 'relate', true,'{/literal}{sugar_translate label='LBL_CONTACTED_BY' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'method_of_contact', 'enum', false,'{/literal}{sugar_translate label='LBL_METHOD_OF_CONTACT' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'sel_selkirk_client_sel_selkirk_activity_name', 'relate', false,'{/literal}{sugar_translate label='LBL_SEL_SELKIRK_CLIENT_SEL_SELKIRK_ACTIVITY_FROM_SEL_SELKIRK_CLIENT_TITLE' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'sel_selkirk_contact_sel_selkirk_activity_name', 'relate', false,'{/literal}{sugar_translate label='LBL_SEL_SELKIRK_CONTACT_SEL_SELKIRK_ACTIVITY_FROM_SEL_SELKIRK_CONTACT_TITLE' module='sel_Selkirk_Activity' for_js=true}{literal}' );
addToValidateBinaryDependency('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='sel_Selkirk_Activity' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='sel_Selkirk_Activity' for_js=true}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'contacted_by', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='sel_Selkirk_Activity' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CONTACTED_BY' module='sel_Selkirk_Activity' for_js=true}{literal}', 'user_id_c' );
addToValidateBinaryDependency('form_SubpanelQuickCreate_sel_Selkirk_Activity', 'sel_selkirk_client_sel_selkirk_activity_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='sel_Selkirk_Activity' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SEL_SELKIRK_CLIENT_SEL_SELKIRK_ACTIVITY_FROM_SEL_SELKIRK_CLIENT_TITLE' module='sel_Selkirk_Activity' for_js=true}{literal}', 'sel_selkirk_client_sel_selkirk_activitysel_selkirk_client_ida' );
