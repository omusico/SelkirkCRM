...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='sel_Selkirk_Approvals'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='assigned_user_name_basic' >{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='sel_Selkirk_Approvals'}</label>
    	</td>
