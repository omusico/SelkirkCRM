...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='document_name_advanced'>{sugar_translate label='LBL_NAME' module='sel_Selkirk_Document'}</label>
		</td>
