...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='document_name_basic'> {sugar_translate label='LBL_NAME' module='sel_Selkirk_Document'}
		</td>
